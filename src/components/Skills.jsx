  ...
  const skillCategories = [
    {
      ...
      skills: ['React', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'HTML/CSS', 'Redux', 'Material UI'],
    ...
    },
    {
      ...
      skills: ['Ruby on Rails', 'Node.js', 'Python', 'REST APIs'],
    ...
    },
    {
      ...
      skills: ['PostgreSQL', 'MySQL', 'MongoDB', 'Redis', 'SQL', 'Database Design'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            A comprehensive set of technologies I use to build modern web applications
          </p>
        </div>
