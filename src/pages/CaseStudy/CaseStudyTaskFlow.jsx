...
function CaseStudyTaskFlow() {
  ...
  const project = {
    name: 'TaskFlow',
    tagline: 'Project management application with real-time collaboration for modern teams',
    heroImage: taskflowImg,
    problem: 'Teams struggle with disorganized workflows, lack of real-time collaboration, and inefficient task tracking. Traditional project management tools are either too complex for small teams or lack essential features for effective team productivity and communication.',
    solution: 'Built a comprehensive project management application with real-time collaboration, intuitive task tracking, and seamless team communication features. The platform helps teams stay organized, track progress effectively, and communicate efficiently in one centralized place.',
    features: [
      ...
      'Custom task labels and categories',
      'User roles and permissions'
    ],
    techStack: ['HTML5', 'CSS3', 'JavaScript', 'React', 'Context API', 'Local Storage', 'Drag-and-Drop API'],
    contributions: [
      'Built the complete frontend application from scratch using React',
      'Implemented real-time collaboration features using WebSocket simulation',
      'Designed intuitive drag-and-drop task management interface',
      'Created fully responsive layouts for desktop, tablet, and mobile devices',
      'Integrated task assignment and real-time notification system',
      'Optimized React component performance using memo and useCallback',
      'Implemented state management using React Context API',
      'Created reusable component library for consistent UI across the app',
      'Built persistent storage using LocalStorage for offline access'
    ],
    challenges: [
      'Managing real-time updates efficiently without performance degradation',
      'Creating an intuitive and smooth drag-and-drop task interface',
      'Ensuring consistent user experience across different devices and screen sizes',
      'Implementing optimistic UI updates for better perceived performance',
      'Handling complex state management with multiple interdependent components'
    ]
  };
...
export default CaseStudyTaskFlow;
