...
function CaseStudyJambarApp() {
  ...
  const project = {
    name: 'Jambar App',
    tagline: 'Service-based platform connecting customers with professional service providers',
    heroImage: jambarImg,
    problem: 'Customers struggle to find reliable service providers (electricians, painters, mechanics, etc.) while professionals face challenges in reaching potential clients. Traditional methods lack efficient communication tools, secure booking systems, and real-time interaction capabilities.',
    solution: 'Built a comprehensive service-based platform that seamlessly connects customers with service providers. The platform enables instant communication through chat, audio, and video features, with secure booking and payment systems.',
    features: [
    ...
    techStack: ['React.js', 'Ruby on Rails', 'PostgreSQL', 'WebSockets', 'Redis', 'Devise', 'Pundit', 'Twilio', 'Firebase'],
    contributions: [
      'Developed RESTful APIs for user management, service requests, and communication features',
      'Implemented authentication using Devise and role-based authorization using Pundit for secure access control',
      'Built responsive UI components with React.js and efficient state management',
      'Integrated real-time features using WebSockets for instant communication between users',
      'Improved performance using Redis caching and implemented pagination for efficient data handling',
      'Designed and managed database schemas using PostgreSQL',
      'Integrated third-party services like Twilio for SMS and Firebase for notifications'
    ],
    challenges: [
      'Implementing real-time audio/video communication with low latency',
      'Managing concurrent user sessions and real-time message synchronization',
      'Ensuring secure role-based access for different user types (customers vs providers)',
      'Optimizing database queries for service provider search and filtering'
    ]
  };
...
export default CaseStudyJambarApp;
